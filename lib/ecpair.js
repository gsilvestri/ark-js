 ...
 * @param {Network} [options.network=networks.kapu]
 */
function ECPair (d, Q, options) {
  ...
  /** @type {Network} */ this.network = options.network || NETWORKS.kapu
}
...
/**
 * @param {Buffer} buffer
 * @param {Network} [network=networks.kapu]
 * @returns {ECPair}
 */
